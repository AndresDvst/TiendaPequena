...
public class Metodo_EfectivoSinDescuento {
    public static void MetodoEfectivo (){
        ...
        while (!cantidadEfectivo) {
            ...
            //Flujo segun caso
            if (tamañoEfectivo > MetodoPago.precioFinal){
                ...
                System.out.println("Y su cuenta es: " + MetodoPago.precioFinal + " USD");
                ...
                while (!confirmacionEfectivo){
                    ...
                    if (confirmacionTamñoEfectivo.equalsIgnoreCase("S") || confirmacionTamñoEfectivo.equalsIgnoreCase("Si")){
                        ...
                        vueltosEfectivo = tamañoEfectivo - MetodoPago.precioFinal;
